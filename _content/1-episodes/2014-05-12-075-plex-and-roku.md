...
The Plex It bookmarklet is fantastic. Find a YouTube or Vimeo video you want to watch later on the TV? Hit the Plex It bookmark and it's added to you Plex queue. I've added a whole lot of music videos this way and it's great.
...
Plex serves up the photos and music files on the Roku. Just add a new media index in Plex and point it to a directory with audio files or images. Plex will index the audio and add meta data. Photos are structured according to the file structure they are saved in and the meta data is available for viewing.

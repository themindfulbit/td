...
soundcloudurl: 060-family-video-conferencing
summary: >
...
> {{ theme:partial src="aside-header" voice="potatowire" text="Irony" }}
>
...
{{ theme:partial src="timestamp" url="{{ soundcloudurl }}" time="17:15" }}

...
summary: >
  Gabe takes time from his high-volume
  blogging schedule to join Erik for a
  chat about writing tools and workflows.
  Along the way, they touch on the apps
  and devices they use to write for the
  web, work, and themselves.
showtype: interview
post_images:
  - 
...
{{ theme:partial src="image" show="{{ number }}" title="Big boned" file="high-volume.jpg" }}
...
From there Gabe's workflow is plain text all the way down, with [Markdown](http://daringfireball.net/projects/markdown/) at its core. From a basic tool like nvALT to the more complex ones such as Sublime Text, it's easy to manage your writing when it all lives in some form of plain text.

{{ theme:partial src="app" show="{{ number }}" image="nvalt.png" name="nvALT" description="Notational Velocity is a way to take notes quickly and effortlessly using just your keyboard. You press a shortcut to bring up the window and just start typing. It will begin searching existing notes, filtering them as you type." price="Free" developer="http://brettterpstra.com/projects/nvalt/" appstore="" }}

{{ theme:partial src="app" show="{{ number }}" image="sublime-text.png" name="Sublime Text" description="Sublime Text is a sophisticated text editor for code, markup and prose.
You'll love the slick user interface, extraordinary features and amazing performance." price="$70" developer="http://www.sublimetext.com/" appstore="" }}

> {{ theme:partial src="aside-header" voice="gabe" text="Sublime Text" }}
>
...
>
> I prefer medium-light text on a dark background. Many people call this "dark mode". I call it "not squinting mode." There are also ["inverted" modes](http://ux.stackexchange.com/questions/26331/why-are-inverted-colors-considered-an-accessibility-feature) that some prefer. Whatever text editor you use, I recommend finding a theme that works everywhere and sticking with it, especially if there is any kind of syntax coloring. It takes the distraction out of the distraction-free writing environment.
>
> Take a look at [Colorsublime](http://colorsublime.com/) for a great collection of themes as well as an interactive demo of each. This is a seriously awesome resource.
>
> [Buy Me a Soda](https://github.com/buymeasoda/soda-theme/) is a very popular theme for Sublime Text and TextMate but there are plenty of [great themes](http://kkga.github.io/spacegray/) around. Pick one and then stick with it for at least 6 months. Stop futzing with your color schemes.
> 
...
> {{ theme:partial src="aside-header" voice="gabe" text="Editorial" }}
>
...
The main things going for Byword are its speed, its simplicity, and its near-unique ability to take Markdown input and [send it to Evernote](http://themindfulbit.com/blog/byword-evernote-bliss). For those reasons, it's what Erik turns to when he isn't using Sublime Text.

* Google Reader was [powered down](http://googlereader.blogspot.com/2013/07/a-final-farewell.html) on July 2, 2013.
* [Generational 041 - Death and Life of RSS](http://technicaldifficulties.us/episodes/041-the-death-and-life-of-rss-with-alex-kessinger)
...
>
> If I were to pick a tool I couldn't live without, it would probably be [TextExpander](https://smilesoftware.com/TextExpander/index.html) by Smile Software. It's the kind of tool that gets stuck in your workflow and never quite gets out. Whenever I'm on a non-TE platform (Windows, Linux, Android, most iOS apps) I find myself typing my snippets and waiting a few seconds for them to appear.
>
> *...and they never do!!! SOB*
>
> TextExpander is such a part of my workflow that I'm a bit afraid to keep using it, since I feel it might disappear on me at any moment. This [nearly happened](http://smilesoftware.com/blog/entry/how-ios-7-affects-textexpander-touch) with iOS 7.
>
...
{{ theme:partial src="fancy-quote" url="{{ soundcloudurl }}" time="0:00" person="erik" quote="And don't call me Shirley." }}
...
{{ theme:partial src="app" show="{{ number }}" image="drafts.png" name="Drafts" description="Drafts is the quick, easy way to capture and share text. In Drafts, text comes first – open the app and get a new, blank draft – ready to type." price="$2.99" developer="http://agiletortoise.com/drafts/" appstore="https://itunes.apple.com/us/app/drafts-quickly-capture-notes/id502385074?mt=8" }}
...
It is worth pointing out that [dead tree paper](http://doanepaper.bigcartel.com/) is still the best choice for when you want to show that you're paying attention and not just multi-tasking.

...
The number of users that a service gains, can be an early indication of future success, but it is far from the only factor. In Slacks's case, the best indication of its potential may be the nearly universal joy it seems to inspire in its users.
